...
INSERT INTO "new_OrderCsvEmailSetting" ("bccEmail", "createdAt", "csvColumns", "emailBody", "emailSubject", "enabled", "fromEmail", "id", "shop", "updatedAt") SELECT "bccEmail", "createdAt", "csvColumns", "emailBody", "emailSubject", "enabled", "fromEmail", "id", "shop", "updatedAt" FROM "OrderCsvEmailSetting";
